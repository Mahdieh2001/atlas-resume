...
for (var i = 1; i <= 16; ++i) {
    ...
    smallCircleL.style.top = (y + totalOffset + window.innerHeight / 2 - 462).toString() + "px";
    smallCircleL.style.left = (x + totalOffset + window.innerWidth / 2 - 966).toString() + "px";
    smallCircleR.style.top = (y + totalOffset + window.innerHeight / 2 - 462).toString() + "px";
...
function moveCircles() {
    ...
    for (let j = 1; j <= 60; j++) {
        for (let i = 0; i < smallCircles.length; i++) {
            ...
            smallCircles[i].style.top = (y + totalOffset + window.innerHeight / 2 - 462).toString() + "px";
